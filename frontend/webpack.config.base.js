...
const PRODUCTION_API_BASE_URL = 'https://boonder.azurewebsites.net/'; // to be changed to point to the URL of your API
...
if (isProductionBuild) {
  console.log("L'API est en mode production");
} else {
  console.log("L'API est en mode développement");
}
